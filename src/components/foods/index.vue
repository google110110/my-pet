<template>
    <div class="warper">
        <div>
            <h4>宠物信息</h4>
            <div class="ful">饥饿度 :   <span :class="{red:full < 2}">{{full | ful}}</span></div>
            <div class="full">
        ...
        <!-- <div class="dog-box"> -->
            ...
            <transition name="fade">
                <div class="food-menu" :style="{'height':+h+'px'}" v-if="flag">
    ...
    export default {
        ...
        methods:{
            ...
            fodnum(foodd,jj){
                ...
                // console.log('fodnum加加',this.foodsnuml)
            },
            imgclick(){
                ...
                this.eatseti = setInterval(function(){
                    if (Object.keys(f).length) {
                        if(_this.full < 5){
                            ...
                            let ft = parseInt(fod.offsetTop) - parseInt(dog.offsetTop)- 70
                            ...
                            if (ft ||fl ) {
                                ...
                                position.y = parseInt(fod.offsetTop) - 70
...
//   }
// }
.food-menu{position: fixed;top: 0;right: 0px;width: 80px;}
